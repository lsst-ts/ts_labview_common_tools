...
<Project Type="Project" LVVersion="18008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="tests" Type="Folder">
			<Item Name="Logger" Type="Folder">
				<Item Name="testCase" Type="Folder">
					<Item Name="testConfig.vi" Type="VI" URL="../../tests/Logger/testCase/testConfig.vi"/>
					<Item Name="testGetErrorInfo.vi" Type="VI" URL="../../tests/Logger/testCase/testGetErrorInfo.vi"/>
					<Item Name="testLogMsg.vi" Type="VI" URL="../../tests/Logger/testCase/testLogMsg.vi"/>
				</Item>
				<Item Name="testLogger.vi" Type="VI" URL="../../tests/Logger/testLogger.vi"/>
			</Item>
			<Item Name="Utility" Type="Folder">
				<Item Name="testCase" Type="Folder">
					<Item Name="testGetLogDir.vi" Type="VI" URL="../../tests/Utility/testCase/testGetLogDir.vi"/>
				</Item>
		...
		<Item Name="Utility" Type="Folder">
			...
			<Item Name="getLogDir.vi" Type="VI" URL="../Utility/getLogDir.vi"/>
		</Item>
